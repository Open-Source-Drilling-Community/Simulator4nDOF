...
The Simulator4nDOF webapp serves as a user interface to manage data associated with Simulator4nDOF microservice

It is packaged as a docker container called:

``norcedrillingsimulator4ndofwebappclient``
