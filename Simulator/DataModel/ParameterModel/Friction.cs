...
namespace NORCE.Drilling.Simulator4nDOF.Simulator.DataModel.ParametersModel
{
    public class Friction
    {
        ...
        public readonly double VelocityTransitionThreshold = 0.05;              // [m/s] Velocity threshold for static to kinetic transition
        ...
        public Friction(int numberOfElements, double mu_s_factor, double mu_k_factor, double stribeck)
        {
            Stribeck = stribeck;
            this.mu_s_factor = mu_s_factor;
            this.mu_k_factor = mu_k_factor;
            Vector<double> vectorOfOnes = Vector<double>.Build.Dense(numberOfElements, 1);
