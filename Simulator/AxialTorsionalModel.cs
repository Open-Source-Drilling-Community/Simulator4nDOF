...
namespace NORCE.Drilling.Simulator4nDOF.Simulator
{
    ...
    {     
        ...
        {   
            ...
            //    DownwardAxialWaveRightBoundary[i]    = - UpwardAxialWave[0, i] + 2 * axialVelocityLeft;
            //    //Right boundaries
            //    UpwardTorsionalWaveLeftBoundary[i] = - DownwardAxialWave[idx, i] + 2 * state.AngularVelocity[i];
